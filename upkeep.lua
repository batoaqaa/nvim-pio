...
--       -- Determine the exact string current_token that was captured in the stream window
--       local final_status = "FAIL"
--       if matched_pass then
--         -- If the matched current_token contains "DONE", return "DONE". Otherwise, return "PASS"
--         final_status = matched_pass:find("DONE") and "DONE" or "PASS"
--       end
--
