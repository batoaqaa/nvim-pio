...
%s
  ...
  boiler = function(self, project_root_param)
    ...
    local function readContent(clangdFile)
      local  ok, content = misc.readFile(clangdFile)
    ...
    -- local  pkgok, pkgcddontent = misc.readFile(pkgClangd)
    -- local  frmok, frmcontent = misc.readFile(cwdClangd)
