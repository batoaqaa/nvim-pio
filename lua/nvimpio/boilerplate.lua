...
%s
  ...
  boiler = function(self, project_root_param)
    ...
    local clangdFiles = {
      ...
      userProj = { file = userClangd, content = function (ref) return M.readContent(ref) end,
      ...
      userGlob = { file = userClangd, content = function (ref) return M.readContent(ref) end, cache_id = '',
        block = function (ref)
