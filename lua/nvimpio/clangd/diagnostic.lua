...
local function inject_into_clangd(code, message)
  ...
  -- FIX: Search dynamic portion for the ACTUAL extracted text written to file instead of the error code title
...
function M.manage_file_diagnostics_interactive()
  ...
  Snacks.picker({
    ...
    layout = 'vscode',
    actions = {
      -- FIX: Map internal row payloads directly via item parameter arrays provided by Snacks Action API
