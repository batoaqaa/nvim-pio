...
local function inject_into_clangd(code, message)
  ...
  -- Exact quote-inclusive verification to stop false-positive containment checks
  ...
  -- 🌟 THE CRITICAL FIX: Add { plain = true } to bypass Lua hyphen regex compilation bugs
  ...
  -- Reconstruct document layout cleanly
