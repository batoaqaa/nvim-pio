...
----------------------------------------------------------------------------------------
-- 🌟 THE INDESTRUCTIBLE NATIVE-C TERMINAL CLASS DEFINITION
----------------------------------------------------------------------------------------
---@class Terminal
...
---@field last_win number|nil 🌟 FIXED TYPE DEFINITION: Explicitly maps the code file window context tracking node
...
function Terminal:on_open()
  ...
  -- 🌟 PROFESSIONAL API SPLIT ALIGNMENT:
...
--   vim.api.nvim_set_option_value('winfixheight', true, { scope = 'local', win = self.win })
--
--   -- 🌟 FIXED CORE CALL: Passes the correctly bound variable to the mapping pipeline
--   self:_register_viewport_mappings(opposite_instance)
-- end
--
-- --- Hook: Launches the active terminal process securely inside the open window context split
